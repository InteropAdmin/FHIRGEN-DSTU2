...
namespace Hl7.Fhir.Publication.Specification.Profile.Operation.Bindings
{
    ...
    {
        public Formatter(string name, string package, OperationDefinition.BindingComponent binding, ResourceStore resourceStore)
            : base(name, package, binding.ValueSet)
        {
